...
export default function HomePageClient({ initialLists, initialFeatured }) {
  const allLists = initialLists || [];
  const featuredList = initialFeatured;
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tab-pill:hover { border-color: #c0392b; color: #c0392b; }
